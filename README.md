...
<html>
  ...
  <body>
  <h1> My name is Rae!</h1>
  
  <h2>Here is how you do the following items </h2>
  <ol>
    <li>Take a screenshot</li>
    <li>Submit an assignment on canvas</li>
    <li>Use common keyboard shortcuts</li>
    <li>Navigate to your favorite website or application</li>
  </ol>
  ...
  <h3>Using common keyboard shortcuts</h3>
  <p>Example text</p>
  
  <h3>Navigating to your favorite website</h3>
  <p>Example text</p>
  </body>
</html>
